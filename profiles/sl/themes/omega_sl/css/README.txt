...
To use these stylesheets, rename the files and omega_sl with the name of your theme.
...
omega_sl-alpha-default-narrow.css  
...
omega_sl-alpha-default-normal.css
...
omega_sl-alpha-default-wide.css
